...
const SignUpPage = () => {
  ...
  const handleSignUp = async (e) => {
    ...
    if (!userName) {
      ...
      setUserNameError("Name must be 2-30 letters and spaces only");
      isValid = false;
    }
    ...
    try {
      // Send registration request to backend auth register endpoint
      const postData = {
        name: userName,
        email,
        password,
      ...
      await axios.post(API_URLS.REGISTER, postData);
      ...
      setSubmitError(serverMessage || "Sign up failed. Try again later.");
    }
  };
        ...
        <Card color="transparent" shadow={false}>
          ...
          >
            <div className="mb-1 flex flex-col gap-5">
              <Typography
                variant="h6"
                color={userNameError ? "red" : "blue-gray"}
                className="-mb-4"
              >
              ...
              <Typography
                variant="h6"
                color={emailError ? "red" : "blue-gray"}
                className="-mb-4"
              >
